...
def CheckTBB():
    ...
    tbb_libs=['tbb'] #cfg.get_lib('tbb','libraries')
...
def CheckCGAL():
    ...
    '''
    tbb_hdirs=cfg.get_dir('CGAL','hdirs')+cfg.get_dir('General','system_hdirs')
    tbb_ldirs=cfg.get_dir('CGAL','ldirs')+cfg.get_dir('General','system_ldirs')
    tbb_libs=cfg.get_lib('CGAL','libraries')
    logger.info('cgal libs %s' % str(tbb_libs))
    return GenerateLibCheck('CGAL',['CGAL/Simple_cartesian.h'],tbb_libs,
                            tbb_hdirs,tbb_ldirs,'C++')
